...
- ✅ **高级草图** - 支持椭圆（Ellipse）、多段线（Polyline）、矩形（Rectangle）、样条曲线（Spline）
- ✅ **交互式绘制** - 鼠标拖动确定尺寸，实时预览
...
### ⚔️ 布尔运算
- ✅ **Union（并集）** - 合并两个实体
- ✅ **Cut（差集）** - 从一个实体中减去另一个实体
- ✅ **Intersect（交集）** - 获取两个实体的交集
...
3. **绘制草图**: 使用 Draw 选项卡中的工具绘制点、线、圆、圆弧、椭圆、矩形、多段线、样条曲线
